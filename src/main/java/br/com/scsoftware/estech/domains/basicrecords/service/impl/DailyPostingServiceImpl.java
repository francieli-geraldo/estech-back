...
import br.com.scsoftware.estech.domains.basicrecords.business.*;
...
import br.com.scsoftware.estech.domains.basicrecords.repository.DailyPostingRepository;
import br.com.scsoftware.estech.domains.basicrecords.service.AgreementService;
...
public class DailyPostingServiceImpl implements DailyPostingService {
    ...
    public DailyPostingBO create(final DailyPostingBO dailyPosting, final Long patientId, final Long agreementId) {
        ...
        dailyPostingEnt.setAgreement(agreementRepository.findByIdAndTenantId(agreementId, UserServiceImpl.getTenantIdAuthenticatedUser()).orElseThrow(ResourceNotFoundException::of));
