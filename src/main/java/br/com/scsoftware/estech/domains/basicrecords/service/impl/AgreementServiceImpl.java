...
import br.com.scsoftware.estech.domains.basicrecords.converter.AgreementConverter;
import br.com.scsoftware.estech.domains.basicrecords.converter.DailyPostingConverter;
...
import br.com.scsoftware.estech.domains.basicrecords.repository.AgreementRepository;
import br.com.scsoftware.estech.domains.basicrecords.repository.PatientRepository;
import br.com.scsoftware.estech.domains.basicrecords.service.*;
...
public class AgreementServiceImpl implements AgreementService {
    ...
    public CreateAgreementBO create(final CreateAgreementBO agreement) {
        ...
        agreementEnt.setPatient(patientRepository.findByIdAndTenantId(agreement.getPatientId(), UserServiceImpl.getTenantIdAuthenticatedUser()).orElseThrow(ResourceNotFoundException::of));
